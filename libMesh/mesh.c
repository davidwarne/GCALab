...
mesh * CreateTorus(void)
{
	...
	vert[0] = 1.000000 * 0.5;	vert[1] = 0.000000;	vert[2] = 0.000000;
	InsertVertex(m->vList,vert);
	vert[0] = 0.309000 *0.5 ;	vert[1] = 0.951100 *0.5;	vert[2] = 0.000000;
	InsertVertex(m->vList,vert);
	vert[0] = -0.809000 *0.5;	vert[1] = 0.587800 *0.5;	vert[2] = 0.000000;
	InsertVertex(m->vList,vert);
	vert[0] = -0.809000 *0.5;	vert[1] = -0.587800 *0.5;	vert[2] = 0.000000;
	InsertVertex(m->vList,vert);
	vert[0] = 0.309000 *0.5;	vert[1] = -0.951100 *0.5;	vert[2] = 0.000000;
	...
	vert[0] = 1.401300;	vert[1] = -1.018100;	vert[2] = 0.000000;
	InsertVertex(m->vList,vert);
	vert[0] = 1.200650 *0.75;	vert[1] = 0.509050 *0.75;	vert[2] = 0.500000;
	InsertVertex(m->vList,vert);
	vert[0] = 0.855150 *0.75;	vert[1] = 0.984600 *0.75;	vert[2] = 0.500000;
	InsertVertex(m->vList,vert);
	vert[0] = 0.654500 *0.5;	vert[1] = 0.475550 *0.5;	vert[2] = 0.000000;
	InsertVertex(m->vList,vert);
	vert[0] = -0.113100 *0.75;	vert[1] = 1.299200 *0.75;	vert[2] = 0.500000;
	InsertVertex(m->vList,vert);
	vert[0] = -0.672100 *0.75;	vert[1] = 1.117550 *0.75;	vert[2] = 0.500000;
	InsertVertex(m->vList,vert);
	vert[0] = -0.250000 *0.5;	vert[1] = 0.769450 *0.5;	vert[2] = 0.000000;
	InsertVertex(m->vList,vert);
	vert[0] = -1.270550 *0.75;	vert[1] = 0.293900 *0.75;	vert[2] = 0.500000;
	InsertVertex(m->vList,vert);
	vert[0] = -1.270550 *0.75;	vert[1] = -0.293900 *0.75;	vert[2] = 0.500000;
	InsertVertex(m->vList,vert);
	vert[0] = -0.809000 *0.5;	vert[1] = 0.000000;	vert[2] = 0.000000;
	InsertVertex(m->vList,vert);
	vert[0] = -0.672100 *0.75;	vert[1] = -1.117550 *0.75;	vert[2] = 0.500000;
	InsertVertex(m->vList,vert);
	vert[0] = -0.113100 *0.75;	vert[1] = -1.299200 *0.75;	vert[2] = 0.500000;
...
mesh * CreateDoubleTorus(void)
{
	...
	vert[0]=-0.418007*1.5;vert[1]= -0.193997*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.306002*1.5;vert[1]= 0.000001*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.418006*1.5;vert[1]= 0.193997*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.642016*1.5;vert[1]= 0.193997*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.754021*1.5;vert[1]= -0.000001*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.642017*1.5;vert[1]= -0.193997*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=0.000000;vert[1]= -0.306003*1.5;vert[2]= 0.500000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.000000;vert[1]= 0.306002*1.5;vert[2]= 0.500000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.530012*1.5;vert[1]= 0.612005*1.5;vert[2]= 0.500000;
	InsertVertex(m->vList,vert);
	vert[0]=-1.060023*1.5;vert[1]= 0.306003*1.5;vert[2]= 0.500000;
	InsertVertex(m->vList,vert);
	vert[0]=-1.060023*1.5;vert[1]= -0.306002*1.5;vert[2]= 0.500000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.530011*1.5;vert[1]= -0.612005*1.5;vert[2]= 0.500000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.030012*1.5;vert[1]= 0.866025*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=-1.030012*1.5;vert[1]= 0.866025*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=-1.530011*1.5;vert[1]= 0.000000;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=-1.030011*1.5;vert[1]= -0.866025*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=-0.030012*1.5;vert[1]= -0.866025*1.5;vert[2]= 0.000000;
	InsertVertex(m->vList,vert);
	vert[0]=0.418007*1.5;vert[1]= -0.193997*1.5;vert[2]= 0.000000;
